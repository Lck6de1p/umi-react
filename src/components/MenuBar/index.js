...
import { BsHouseDoorFill, BsHouseDoor, BsBagFill, BsBag,
BsPersonFill, BsPerson } from 'react-icons/bs'
    ...
    constructor(props) {
        ...
        this.state = {
            items: [
                ...
                {
                    title: '订单',
                    selectIcon: <BsBagFill style={{fontSize: '1.5rem'}} />,
